 ...
 */
export default {
  components: { Layout, PageHeader, VueFormWizard: FormWizard, TabContent ,Multiselect},
  data() {
    return {
    ...
    validations:{
      ...
      // feature create api call 
        submitFeature(e)
        {
          ...
          this.$v.$touch();
          axios.post('/api/feature/update/'+this.$route.params.id,{
        ...
        onCategory(e)
          ...
          editFeature()
          {
               axios.get('/api/feature/edit/'+this.$route.params.id)
            .then((response)=> {
          ...
          featureDataDataTable()
          {
            axios.get('/api/feature/data/'+this.$route.params.id)
            .then((response)=>
            { 
    ...
    <div class="row">
     ...
     <div class="row">
      <div class="col-12">
          ...
          <div class="card-body">
            ...
            <div class="table-responsive mb-0">
              <b-table
                ...
                @filtered="onFiltered"
              >
              <!-- edit and delete dataes  -->
                  <template #cell(actions)="featureData">
        <router-link
        :to="{name:'feature-data-create',params: { id: featureData.item.s_id}}"
        ...
        <b-button size="sm"  class="btn-danger" v-on:click="deleteFeature(featureData.item.id)">
         Delete
        </b-button>
      </template>
