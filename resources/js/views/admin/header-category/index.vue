  ...
  data() {
    return {
      ...
      fields: [
        ...
        { key: "ne_name", label:"NE Name", sortable: true },
  ...
  <Layout>
    ...
    <div class="row">
      ...
      <div class="col-12">
        <div class="card">
            <router-link
        :to="{name:'header-category-create'}"
          ...
          <div class="card-body">
            ...
            <div class="table-responsive mb-0">
              <b-table
                ...
                @filtered="onFiltered"
              >
 <template #cell(actions)="categoryData">
        <router-link
        :to="{name:'header-category-edit',params: { id: categoryData.item.id }}"
        tag="v-btn" align="right">
