...
export default {
  ...
  methods: {
    webadsDataEdit()
    {
      axios.get('/api/web-ads/edit/'+this.$route.params.id)
      .then((response)=> {
   ...
   /*Initialize the form data
          ...
          let  webadsData = this.typeform;
           webadsData = JSON.stringify(webadsData)
            formData.append('file', this.file); 
              formData.append('data', webadsData)

      this.typesubmit = true;
      // stop here if form is invalid
      this.$v.$touch();

     axios.post('/api/web-ads/update/'+this.$route.params.id,formData,{
          headers: {
             ...
             <div class="row">
                  <div class="mb-3 col-md-6">
                    ...
                    'is-invalid': typesubmit && $v.typeform.page.$error,
                      ...
                      <option value="job-right">Job-right</option>
                      <option value="job-left">Job-left</option>
                      <option value="property-top">Property-top</option>
                      <option value="property-bottom">Property-bottom</option>
                    </select>
                       <div
