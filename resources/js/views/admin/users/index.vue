  ...
  data() {
    return {
      ...
      fields: [
        ...
        { key: "admin_user", label:"Role", sortable: true },
...
<template>
  <Layout>
    ...
    <div class="row">
          ...
          <div class="card-body">
            ...
            <div class="table-responsive mb-0">
              <b-table
                ...
                @filtered="onFiltered"
              >
               <template #cell(action)="users">
        <router-link
        :to="{name:'user-edit-view',params: { id: users.item.id }}"
      ...
      <a :href="'./orders/?user_id=' +users.item.id " target="_balnk" class="btn btn-secondary btn-sm">View Orders</a>
      </template>
              </b-table>
