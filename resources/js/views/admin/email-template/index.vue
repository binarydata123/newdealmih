...
<template>
 ...
 <template #cell(actions)="data">
        ...
        <a :href="'/email-template/edit/' +data.item.id " target="_balnk" >Edit</a>
      <!-- </router-link> -->

        <!-- <b-button size="sm"  class="btn-danger" v-on:click="deleteCategory(data.item.id)">
         Delete
        </b-button> -->
      </template>
              </b-table>
