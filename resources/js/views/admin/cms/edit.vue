...
export default {
  ...
  methods: {
    cmsEdit()
    {
      axios.get('/api/cms/edit/'+this.$route.params.id)
      .then((response)=> {
      ...
      setTimeout(() => this.selectData = false, 18000);
    },
   ...
   /*Initialize the form data
     ...
     axios.post('/api/cms/update/'+this.$route.params.id,formData,{
          headers: {
          ...
          <div class="mb-3 col-md-6">
            <label for="">Image</label>
                 <div class="card">
                  ...
                  <br>
                   <img v-bind:src="'/media/cms-image/' + typeform.image" width="100" height="100"  /> 
            </div>
            
              </div>
              <div class="mb-3 mb-0">
                <div align="right">
                  <button :disabled="selectData" type="submit" class="btn btn-primary">Submit</button>
