...
export default {
  ...
  methods: {
    ...
    changeCommission()
    {
      axios.get('/api/commission/edit/'+this.$route.params.id)
      .then((response)=>{
        ...
        .then(response => { 
          ...
          var result = response.data;
            ...
            Vue.swal({
                ...
                this.$router.push("/dashboard/commission");
              }
        })
        .catch(error => {
            console.log(error)
          ...
          <div class="card-body">
            ...
            <form action="#" @submit.prevent="typeForm">
              <div class="row">
                ...
                <label> Title</label>
                <input
                  v-model="typeform.percent"
                  type="number"
                  class="form-control"
                  placeholder="Type Commission Perecent"
                  name="percent"
                  :class="{
