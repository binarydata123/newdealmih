  ...
  data() {
    return {
      ...
      fields: [
        ...
        { key: "title", label:"Titl English", sortable: true },
        { key: "ne_title", label:"Title Nepal",sortable: true },
          ...
          <div class="card-body">
            ...
            <div class="table-responsive mb-0">
              <b-table
                ...
                @filtered="onFiltered"
              >
 <template #cell(actions)="cmsData">
        <router-link
        :to="{name:'cms-edit',params: { id: cmsData.item.id }}"
        tag="v-btn" align="right">
